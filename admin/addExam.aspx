<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="addExam.aspx.cs" Inherits="WebUni_Project.admin.addExam1" %>
            ...
            <main class="content flex-fill p-4">
                ...
                <div class="content-wrapper p-4">
                    <div class="form-section-container">
                        <div class="form-page">
                            <h2 class="text-primary mb-4">Add Exam</h2>
                            <form>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <asp:Label ID="Label2" runat="server" Text="Exam Name" CssClass="form-label"></asp:Label>
                                    <asp:TextBox ID="txtenm" runat="server" CssClass="form-control" placeholder="e.g., CIE-I"></asp:TextBox>
                                </div>
                                <div class="mb-3">
                                    <asp:Label ID="Label3" runat="server" Text="Duration" CssClass="form-label"></asp:Label>
                                    <asp:TextBox ID="txtdr" runat="server" CssClass="form-control" placeholder="e.g., 20"></asp:TextBox>
                                </div>
                                <div class="mb-4">
                                    <asp:Label ID="Label4" runat="server" Text="Total Marks" CssClass="form-label"></asp:Label>
                                    <asp:TextBox ID="txttm" runat="server" CssClass="form-control" placeholder="e.g., 10"></asp:TextBox>
                                </div>
                                <asp:Button ID="btnexam" runat="server" Text="Add Exam" OnClick="btnexam_Click" CssClass="btn btn-primary btn-lg w-100" />
                            </form>
                        </div>
                    </div>
