<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="attemptExams.aspx.cs" Inherits="WebUni_Project.admin.attemptExams" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
                ...
                <head>
                    <meta charset="UTF-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Students</title>
    ...
    <div class="content-wrapper p-4">
        ...
        <h2 class="text-primary mb-4">Exam Attempt Students</h2>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder2">
    <footer class="bg-dark text-white text-center p-2">
        <p>
            &copy; 2025 Online Exam System</p>
    </footer>
